...
- 위쪽에 영상이 표시되고, 그 아래에 탐색 바와 전체화면 버튼이 있습니다.
- 탐색 바 아래에는 시간 눈금자가 있고, A와 B 마커가 여기에 표시됩니다.
- A와 B가 모두 설정되면 보라색 정보 바가 나타납니다. 구간 표시, 미세 조정 버튼, 구간 자막 생성 버튼, 쉐도잉용 마이크 버튼, 구간을 해제하는 닫기 버튼이 들어 있습니다.
- 그 아래에 재생 컨트롤이 있습니다. **A-B**, 반복 횟수, 재생 속도, 쉐도잉 간격, 5초 뒤/앞 이동, 재생/일시정지, 북마크 저장용 **Save**입니다.
- 맨 아래에는 저장한 **Bookmarks**와 **My Recordings**가 표시됩니다.
