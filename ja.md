...
- 上部に映像が表示され、その下にシークバーと全画面ボタンがあります。
- シークバーの下には時間ルーラーがあり、A と B のマーカーがここに表示されます。
- A と B の両方を設定すると、紫の情報バーが表示されます。区間表示、微調整ボタン、シーン文字起こしボタン、シャドーイング用のマイクボタン、区間を解除する閉じるボタンが並びます。
- その下に再生コントロールがあります。**A-B**、リピート回数、再生速度、シャドーイング間隔、5 秒戻る/進む、再生/一時停止、ブックマーク保存用の **Save** です。
- 一番下には、保存した **Bookmarks** と **My Recordings** が表示されます。
