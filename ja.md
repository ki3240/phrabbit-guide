...
Phrabbit は、外国語のリスニング練習のための A/B 区間リピートアプリです。音声ファイル、動画ファイル、ミュージックライブラリの曲、ポッドキャスト、YouTube リンクを学習素材として追加し、聞きたい区間だけを繰り返したり、自分の声でシャドーイング練習をしたりできます。音声テキスト変換、単語帳、シャドーイング録音、学習記録も利用できます。
...
13. [ポッドキャスト](#13-ポッドキャスト)
14. [学習記録と設定](#14-学習記録と設定)
15. [無料版とプレミアム](#15-無料版とプレミアム)
16. [よくある質問](#16-よくある質問)
...
### 2-2. お気に入りとフォルダ
ライブラリ項目を長押ししてコンテキストメニューを開きます。**Add to Favorites** でお気に入りに追加したり、**Move to Folder…** で整理したりできます。お気に入りが 1 件以上あるとワードマークの下に **All / Favorites** チップが表示されます。**Favorites** を選ぶと、フォルダに関係なくライブラリ全体のお気に入りだけが表示されます。
...
### 2-4. 削除
項目を左にスワイプして **Delete** をタップします。誤ってスクロールしただけで削除されないよう、全体スワイプによる削除は無効になっています。削除すると、その素材に関連する波形キャッシュ、ブックマーク、字幕、保存済みシャドーイング録音も一緒に整理されます。保存済み録音がある項目では、削除前に確認画面が表示されます。
...
詳しくは [13. ポッドキャスト](#13-ポッドキャスト) を参照してください。
...
ブックマークと録音の両方がある場合は、**Bookmarks / My Recordings** の切り替えで一覧を分けて表示します。ブックマークが 2 件以上あると、**Play All** メニューが表示される場合があります。複数のブックマークを順番に再生し、それぞれを 1、2、3 回ずつ繰り返すよう設定できます。ブックマークを左にスワイプすると **Rename** と **Delete** が表示され、タップして実行できます。
...
- 全画面練習に対応
- YouTube リンクごとにブックマークとシャドーイング録音を保存。ブックマークは自動名ですぐに保存され、保存トーストまたは保存済みの行から **Rename** で名前を変更できます。
...
端末や iCloud Drive にある動画ファイルも学習素材として使えます。動画でも音声と同じ A/B 区間リピート、シャドーイング、ブックマークをそのまま利用でき、字幕は別途用意した字幕ファイルを読み込んで使います。
...
- A と B の両方を設定すると、区間情報バーが表示されます。区間表示、微調整ボタン、シーン文字起こしボタン、シャドーイング用のマイクボタン、区間を解除する閉じるボタンが並びます。
- その下に再生コントロールがあります。**A-B**、リピート回数、再生速度、シャドーイング間隔、5 秒戻る/進む、再生/一時停止、ブックマーク保存用の **Save** です。
- 一番下には、保存した **Bookmarks** と **My Recordings** が表示されます。両方ある場合は切り替えで一覧を分けて表示します。
...
字幕は映像の下部に表示されます。字幕をタップすると非表示にでき、長押しすると現在の文をその場で編集できます。UTF-8 以外のエンコードで保存された字幕ファイルは読み込めないことがあるため、UTF-8 テキストで保存し直してからお試しください。

字幕文のプラスボタンをタップすると、単語を単語帳に保存できます。単語帳はプレミアム機能です。
...
### 11-7. 名前の変更と削除
動画のタイトルは、最初はファイル名で表示されます。ライブラリで動画を長押しして **Rename Video** を選ぶと変更できます。

動画を左にスワイプして削除すると、Phrabbit 側の項目情報と字幕、ブックマーク、保存済みシャドーイング録音が整理されます。**元の動画ファイルは削除されません。** 保存済み録音がある場合は、削除前に確認画面が表示されます。
